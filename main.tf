...
data "http" "verify_instance" {
  url = "https://raw.githubusercontent.com/MetroStar/terraform-aws-win-python-ec2/master/python_test.ps1"
}

# userdata ===========================
data "http" "userdata" {
  url = "https://raw.githubusercontent.com/MetroStar/terraform-aws-win-python-ec2/master/userdata.ps1"
}
